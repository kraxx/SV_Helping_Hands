...
import { View, StyleSheet, Text, Image, Modal, TouchableOpacity, Button, Platform } from 'react-native';
...
class MapScreenView extends Component {
    ...
    render() {
        ...
        let marginTop = (platform === 'ios') ? 24 : 0
        return (
            <View style={styles.container}>
                <View style={[styles.mapScreen, {"marginTop": marginTop}]}>
                    <MapWrapper
